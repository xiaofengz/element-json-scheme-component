        ...
        return h(
          'el-table',
          {
            ...
            on: {
              ...
              'sort-change': ({ column, prop, order }) => vm.emitEventHandler('sort-change', { column, prop, order }),
    ...
    methods: {
      ...
      renderCloumn(h, context, item) {
        ...
        return h(
          ...
          }, item.prop && vm.cloumnsRender[item.prop] ? {scopedSlots: {
            default: props => {
